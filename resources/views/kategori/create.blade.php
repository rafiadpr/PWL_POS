        ...
        <form method="POST" action="{{ url('kategori') }}" class="form-horizontal">
            ...
            <div class="form-group row">
                ...
                <div class="col-11">
                    ...
                    @error('kategori_kode') <small class="form-text text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-11">
                    ...
                    @error('kategori_nama') <small class="form-text text-danger">{{ $message }}</small> @enderror
                </div>
            </div>
            <div class="form-group row">
